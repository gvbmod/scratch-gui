    ...
    >
        <Box className={styles.body}>
            ...
            <p className={styles.helpText}>
                <FormattedMessage
                    // eslint-disable-next-line max-len
                    defaultMessage="Note that anyone can change their username to anything. So beware that some people can change their username to another any time. For example: Griffpatch might not actually be Griffpatch, and is impersonating Griffpatch."
                    description="Text in change username modal"
