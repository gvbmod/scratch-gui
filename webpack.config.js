...
const base = {
    ...
    output: {
        library: 'GUI',
        filename: process.env.NODE_ENV === 'production' ? 'buildjavascript/[name].[contenthash].js' : 'buildjavascript/[name].js',
        chunkFilename: process.env.NODE_ENV === 'production' ? 'buildjavascript/[name].[contenthash].js' : 'buildjavascript/[name].js',
        publicPath: root
    },
    resolve: {
        symlinks: false,
